  ...
  return (
    <div className="settings-view">
      ...
      <section className="workspace" aria-labelledby="philosophy-heading">
        ...
        <p className="section-copy">
          心理乐高——把人类的认知、思维模型、技能与知识库拆解为像乐高积木一样的"标准模块"，
        ...
        <div className="provider-lanes philosophy-lanes">
          ...
          <article>
            ...
            <p>
              原子化知识：如卡片盒笔记法（Zettelkasten）强调的，每条笔记只讲一个独立概念——
              这正是知识层面的乐高积木，可以随时组合成一篇文章、一个方案或一次洞察。
            </p>
            <p>
              认知迭代的敏捷性：环境变化时不必推翻整个认知体系，
              只需"拆掉几块积木，换上新模块"，就完成一次思维的迭代。
            </p>
          </article>
        </div>
        <p className="section-copy">
